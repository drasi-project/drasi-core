# Basic Drasi Server Core Integration Example

This example demonstrates the simplest possible way to integrate Drasi Server Core into a Rust application. It showcases the core concepts of Sources, Queries, and Reactions in both configuration-based and programmatic approaches.

## What This Example Demonstrates

- **Easy Integration**: How to embed Drasi Server Core in your application with just a few lines of code
...
Initializing Drasi Server Core...
Starting Drasi Server Core...
Drasi Server Core is running!
...
```rust
use drasi_server_core::config::{DrasiServerCoreConfig, SourceConfig, QueryConfig, ReactionConfig};
...
- [Drasi Server Core Documentation](../../README.md)
