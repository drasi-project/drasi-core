...
///
/// ```no_run
/// # use drasi_server_core::{DrasiServerCore, Source, Properties};
/// # use serde_json::json;
/// # async fn example() -> Result<(), Box<dyn std::error::Error>> {
/// let core = DrasiServerCore::builder()
///     .add_source(
...
impl SourceBuilder {
    ...
    /// ```no_run
    /// # use drasi_server_core::{DrasiServerCore, Source};
    /// # use drasi_server_core::bootstrap::{BootstrapProviderConfig, ScriptFileBootstrapConfig};
    /// # async fn example() -> Result<(), Box<dyn std::error::Error>> {
    ...
    ///
    /// ```no_run
    /// # use drasi_server_core::{DrasiServerCore, Source, DispatchMode};
    /// # async fn example() -> Result<(), Box<dyn std::error::Error>> {
    /// let core = DrasiServerCore::builder()
    ///     .add_source(
    ///         Source::application("events")
