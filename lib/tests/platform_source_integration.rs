...
use drasi_lib::config::{PlatformSourceConfig, SourceConfig, SourceSpecificConfig};
use drasi_lib::sources::platform::PlatformSource;
...
async fn create_test_source(
    ...
    Box<
        ...
        >,
    >,
    mpsc::Receiver<drasi_lib::channels::ComponentEvent>,
) {
