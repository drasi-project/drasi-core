...
//! Migrated typed change validation and canonical identities used by computation
//! boundary codecs. Graph edges use the versioned ChangeEnvelope, not this private
