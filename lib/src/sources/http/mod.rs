...
//! HTTP source for receiving graph data changes via REST API endpoints.
//!
//! The HTTP source provides endpoints for submitting single events or batches,
//! with optional adaptive batching for optimal throughput.
