...
**Important:** This is a Rust-only API. The TypeSpec file is for documentation only. Applications embed DrasiLib and call Rust APIs directly using `drasi_core::models` types.
