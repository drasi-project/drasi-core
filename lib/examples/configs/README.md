# Drasi Lib Configuration Examples

This directory contains example configurations that demonstrate how to configure various features of Drasi Lib. Each example folder contains three equivalent configuration formats:
...
- Best for embedding Drasi Lib as a library
...
drasi-lib --config examples/configs/basic-mock-source/config.yaml
```
