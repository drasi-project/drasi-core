...
use crate::{MsSqlStoredProcReaction, QueryConfig, TemplateSpec};
...
#[derive(Debug, Clone, Serialize, Deserialize, utoipa::ToSchema)]
#[schema(as = reaction::storedproc_mssql::StoredProcQueryConfig)]
#[serde(deny_unknown_fields, rename_all = "camelCase")]
...
#[derive(Debug, Clone, Serialize, Deserialize, utoipa::ToSchema)]
#[schema(as = reaction::storedproc_mssql::MsSqlStoredProcReactionConfig)]
...
#[async_trait]
impl ReactionPluginDescriptor for MsSqlStoredProcReactionDescriptor {
    fn kind(&self) -> &str {
        "storedproc-mssql"
    }
    ...
    fn config_schema_name(&self) -> &str {
        "reaction.storedproc_mssql.MsSqlStoredProcReactionConfig"
    }
    ...
    async fn create_reaction(
        ...
        let dto: MsSqlStoredProcReactionConfigDto = serde_json::from_value(config_json.clone())?;
