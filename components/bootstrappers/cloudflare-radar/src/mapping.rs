...
pub fn map_leak(source_id: &str, leak: &BgpLeakEvent, include_shared: bool) -> Vec<SourceChange> {
    let mut changes = Vec::new();
...
pub fn map_http_summary(
    ...
    build_node(source_id, node_id, "HttpTraffic", props, effective_from)
}
...
pub fn map_attack_l7_summary(
    ...
    build_node(source_id, node_id, "AttackL7", props, effective_from)
}
...
pub fn map_attack_l3_summary(
    ...
    build_node(source_id, node_id, "AttackL3", props, effective_from)
}
...
pub fn map_dns_summary(
    ...
    let locations_value = serde_json::to_value(locations).unwrap_or(serde_json::Value::Null);
