...
pub use vtables::{
    ...
    FfiBootstrapReceiver, FfiBootstrapResult, FfiBootstrapSender, FfiChangePushCallbackFn,
    FfiChangeReceiver, FfiPluginRegistration, FfiResultPushCallbackFn, FfiRuntimeContext,
