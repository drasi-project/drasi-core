...
pub use vtables::{
    ...
    FfiBootstrapSender, FfiChangeReceiver, FfiChangePushCallbackFn, FfiPluginRegistration,
    FfiQueryResultEvent, FfiQueryResultReceiver, FfiRuntimeContext, FfiSourceEvent,
