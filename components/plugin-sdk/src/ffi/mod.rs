...
pub use vtables::{
    ...
    FfiBootstrapReceiver, FfiBootstrapResult, FfiBootstrapResultCallbackFn,
    FfiBootstrapResultReceiver, FfiBootstrapSender, FfiChangePushCallbackFn, FfiChangeReceiver,
