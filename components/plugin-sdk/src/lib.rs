    ...
    (
        ...
        pub extern "C" fn drasi_plugin_init() -> *mut $crate::ffi::FfiPluginRegistration {
            match ::std::panic::catch_unwind(|| {
                ...
                let (mut source_descs, mut reaction_descs, mut bootstrap_descs, mut identity_provider_descs, mut secret_store_descs) = $init_fn();
                ...
                ::std::mem::forget(secret_store_descs);
